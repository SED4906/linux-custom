...
// This is pretty much a copy of the one for mt2701
...
static DEFINE_SPINLOCK(mt8127_clk_lock);
...
CLK_OF_DECLARE_DRIVER(mtk_infra, "mediatek,mt8127-infracfg",
...
static const struct mtk_gate peri_clks[] = {
	...
	GATE_PERI0(CLK_PERI_ETH, "eth_ck", "clk26m", 28),
...
static const struct mtk_pll_data apmixed_plls[] = {
	...
	PLL(CLK_APMIXED_UNIVPLL, "univpll", 0x220, 0x22c, 0x04000000,
...
static const struct of_device_id of_match_clk_mt8127[] = {
	{
		.compatible = "mediatek,mt8127-topckgen",
		.data = mtk_topckgen_init,
	}, {
		.compatible = "mediatek,mt8127-infracfg",
		.data = mtk_infrasys_init,
	}, {
		.compatible = "mediatek,mt8127-pericfg",
...
MODULE_DEVICE_TABLE(of, of_match_clk_mt8127);

static int clk_mt8127_probe(struct platform_device *pdev)
{
...
static struct platform_driver clk_mt8127_drv = {
	.probe = clk_mt8127_probe,
	.driver = {
		.name = "clk-mt8127",
		.of_match_table = of_match_clk_mt8127,
	},
};

static int __init clk_mt8127_init(void)
{
	return platform_driver_register(&clk_mt8127_drv);
}

arch_initcall(clk_mt8127_init);

MODULE_DESCRIPTION("MediaTek MT8127 main clocks driver");
MODULE_LICENSE("GPL");
